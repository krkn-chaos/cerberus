...
1. Git clone the Cerberus repository using `git clone https://github.com/redhat-chaos/cerberus.git`.
...
1. Git clone the Cerberus repository using `git clone https://github.com/redhat-chaos/cerberus.git` on an IBM Power Systems server.
2. Modify the python code and yaml files to address your needs.
